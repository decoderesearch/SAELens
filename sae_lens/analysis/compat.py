...
def has_transformer_bridge() -> bool:
    ...
    # accommodate when transformerlens is installed from source and version is set to 0.0.0
    if parse_version(importlib.metadata.version("transformer-lens")) == parse_version("0.0.0"):
        return True
