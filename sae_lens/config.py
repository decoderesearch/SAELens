...
class LanguageModelSAERunnerConfig(Generic[T_TRAINING_SAE_CONFIG]):
    ...
    Args:
        ...
        activations_mixing_fraction (float): Fraction of the activation buffer to keep for mixing with new activations (default 0.5). Higher values mean more temporal shuffling but slower throughput.
